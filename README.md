...
This course is the fourth in a series of 5 courses about Red Hat OpenShift Dev Spaces. This course covers how to create and customize **Workspaces** in Red Hat OpenShift Dev Spaces.
...
```
    $ git clone git@github.com:RedHatQuickCourses/devspaces-workspaces.git
```

2. Install the npm dependencies for the course tooling.
```
    $ cd devspaces-workspaces
    $ npm install
```
...
12. Verify that your changes have been published to the production GitHub pages website at https://redhatquickcourses.github.io/devspaces-workspaces

# Problems and Feedback
If you run into any issues, report bugs/suggestions/improvements about this course here - https://github.com/RedHatQuickCourses/devspaces-workspaces/issues
