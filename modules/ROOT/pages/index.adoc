...
. https://redhatquickcourses.github.io/devspaces-plugins[Configuring IDE Extensions in Red Hat OpenShift Dev Spaces^]

This course covers how to create, customize, and manage `Workspaces` on Dev Spaces.

NOTE: The hands-on labs for this course have been tested on *Red Hat OpenShift Dev Spaces 3.27*. The labs should mostly work on minor update releases of Dev Spaces. If you encounter any issues, please open a GitHub issue in the course repository.
