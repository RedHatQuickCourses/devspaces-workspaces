...
The Dev Spaces Dashboard provides a collection of _Getting Started_ samples that allow developers to quickly create workspaces from preconfigured Devfiles and source repositories.

image::dashsample.png[title=Dashboard Getting Started Samples]
...
* https://docs.redhat.com/en/documentation/red_hat_openshift_dev_spaces/3.27/html-single/administration_guide/index#configuring-getting-started-samples_administration_guide[Configure getting started samples^]